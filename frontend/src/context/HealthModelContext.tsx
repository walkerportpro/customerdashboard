...
const SEED_EXCEPTIONS: ExceptionRule[] = [
  {
    ...
    description: "Force At Risk when a P1 ticket has been open for more than 48 hours",
    conditions: [
  ...
  },
  {
    ...
    name: "Invoice Overdue Cap",
    description: "Cap score at 40 when an invoice is more than 30 days past due",
    conditions: [
      { signal: "invoice_days_overdue", operator: "gt", value: 30, conjunction: "and" },
    ],
    action: "cap_score",
    action_value: 40,
    priority: 90,
  ...
  {
    id: "exc-impl-behind",
    name: "Implementation Behind Schedule",
    description: "Force Monitor when implementation is behind schedule by more than 21 days",
    conditions: [
      { signal: "implementation_days_behind", operator: "gt", value: 21, conjunction: "and" },
    ],
    action: "force_band",
  ...
  },
  {
    ...
    description: "Subtract 15 points when average sentiment score drops below 0.25",
    conditions: [
...
const SEED_AUDIT_LOG: AuditLogEntry[] = [
  {
    ...
    action: "publish",
    details: "Published version 5 with updated support burden thresholds",
    version: 5,
    changes: { components_modified: ["comp-sup"], bands_changed: false },
  },
  {
    id: "audit-002",
    ...
    user: "sarah.chen@example.com",
    action: "draft_save",
    details: "Adjusted Support Burden thresholds and added Escalation Risk component",
    version: 5,
    changes: { components_added: ["comp-esc"], components_modified: ["comp-sup"] },
  },
  {
    id: "audit-003",
    ...
    action: "publish",
    details: "Published version 4 with new Renewal Risk component",
    version: 4,
    changes: { components_added: ["comp-rnw"], weights_changed: true },
  },
  {
    id: "audit-004",
    ...
    user: "sarah.chen@example.com",
    action: "publish",
    details: "Published version 3 with segment-based weight overrides",
    version: 3,
    changes: { segments_added: ["seg-onb", "seg-ent", "seg-smb"] },
  },
  {
    id: "audit-005",
    ...
    user: "mike.johnson@example.com",
    action: "publish",
    details: "Initial health model configuration with 6 core components",
    version: 2,
    changes: { initial_setup: true, component_count: 6 },
  },
];
